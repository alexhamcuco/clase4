...
const Condiciones = () => {
    return (
        <div >
            <Heading fontSize="xl" as="h6" sx={{ color: 'green', marginTop: '60px', fontWeight: 'bold' }}>
                Términos y Condiciones
            </Heading>

            <Text fontSize="xl" as="h6" mt={4} sx={{ textAlign: 'justify', marginLeft: '50px', marginRight: '200px', mt: '40px', mb: '60px', }}>
            ...
            <Heading as="h3" fontSize="md" mt={4} sx={{ fontWeight: 'bold', marginLeft: '40px', marginRight: '20px', mt: '300px', }}>
            ...
            <Text fontSize="xl" as="h6" mt={4} sx={{ fontWeight: 'bold', color: 'red', textAlign: 'justify', marginLeft: '50px', marginRight: '50px', mt: '300px', mb: '60px', }}>
